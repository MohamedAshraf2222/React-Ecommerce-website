...
const ItemView = () => {
    const { SaveItems, SetItem } = useContext(BagItemsContext)
                ...
                <div className='itemview-content'>
                    ...
                    <div className="itemview-grid gap-12">
                        ...
                        <div className='flex flex-col gap-2'>
                            <div className='itemview-name-font font-bold'>
                                {item.name}
                            </div>
                            ...
                            <div className="itemview-prise-font">
                                $ {item.price}
                            </div>
                    ...
                    <div className='flex justify-end mt-4 mb-10 mr-3'>
                        <button className='btn-bag flex items-center' onClick={() => SetItem(item.id)}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
