        ...
        <div className="bag-checkout">
          <div className="flex">
            ...
            <div className="flex flex-col mt-20 items-center px-bag">
              <h3 className="font-bag bag-font-bag">Bag</h3>
              <div className="flex flex-wrap justify-center bag-content gap-4">
              ...
              <Link className="mt-8" to={"/checkout"}>
                <button className="btn-bag bag-btn-bag flex gap-2 items-center">
                  <svg
                    width="20"
                    height="22"
                    viewBox="0 0 20 22"
